...
$string['scanalignmenthelp'] = 'These values correct for the difference between the worksheet as printed and the worksheet as scanned back in. They decide where a display-only area\'s image is cut from the crop stored for it, so changing them takes effect on the next preview or PDF - submissions do not need to be re-uploaded or re-processed. Leave a field blank to use the site default.';
$string['scanalignmentpadnote'] = 'Corrections apply to display-only areas, and are limited by the crop margin, currently {$a}mm, since that is how much extra was captured around each one. Submissions processed before the margin was introduced have no room to shift and are left as they are.';
...
$string['alignoffsetx'] = 'Horizontal offset (%)';
$string['alignoffsetx_desc'] = 'How far right the scanned content sits compared with the template, as a percentage of the page width. Use a negative value when the scan sits to the left.';
$string['alignoffsetx_help'] = 'How far right the scanned content sits compared with the template, as a percentage of the page width. Use a negative value when the scan sits to the left. One percent of an A4 page is about 2.1mm.';
$string['alignoffsety'] = 'Vertical offset (%)';
$string['alignoffsety_desc'] = 'How far down the scanned content sits compared with the template, as a percentage of the page height. Use a negative value when the scan sits higher.';
$string['alignoffsety_help'] = 'How far down the scanned content sits compared with the template, as a percentage of the page height. Use a negative value when the scan sits higher. One percent of an A4 page is about 3mm.';
...
$string['alignscalex_help'] = 'How much wider the scanned content is than the template, as a percentage. 100 means no difference; 102 means the scan is stretched two percent wider. Use this when the misalignment grows across the page rather than staying constant.';
...
$string['alignscaley_help'] = 'How much taller the scanned content is than the template, as a percentage. 100 means no difference; 102 means the scan is stretched two percent taller. Use this when the misalignment grows down the page rather than staying constant.';
...
$string['alignmentdetect'] = 'Detect from a scanned submission';
...
$string['alignmentdetectbutton'] = 'Detect alignment';
...
$string['alignmentmeasuredoffset'] = 'Offset (%)';
