...
class process_submissions_task extends \core\task\adhoc_task {
    ...
    public function execute() {
        ...
        $paper = $DB->get_record('paper', ['id' => $customdata->paperid], '*', MUST_EXIST);

        $processor = new \mod_paper\submission_processor($paper);
        $processor->process_batch($customdata->batchid);
    }
}
